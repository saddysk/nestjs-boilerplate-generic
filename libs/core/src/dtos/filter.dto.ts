import {
  ...
  ObjectFieldOptional,
  UUIDFieldOptional,
} from '@skull/core/decorators/field.decorators';
...
export class DateFilterDto extends BaseFilterOperatorDto implements IDateFilter {
  @DateFieldOptional({
...
export class NumberFilterDto extends BaseFilterOperatorDto implements INumberFilter {
  @NumberFieldOptional({
...
export class StringFilterDto extends BaseFilterOperatorDto implements IStringFilter {
  @StringFieldOptional({
    description: 'Returns values that contain the given string using sql LIKE operator',
  })
  like?: string;

  @StringFieldOptional({
    description: 'Returns values that contain the given string case insensitively using sql ILIKE operator',
  })
  ilike?: string;
...
export class StringArrayFilterDto extends BaseFilterOperatorDto implements IArrayFilter<string> {
  @StringFieldOptional({
    isArray: true,
    description: 'Returns values in the given array',
  })
...
export class NumberArrayFilterDto extends BaseFilterOperatorDto implements IArrayFilter<number> {
  @NumberFieldOptional({
    isArray: true,
    description: 'Returns values in the given array',
  })
...
export class DefaultResourceFilterDto extends PaginationFilterDto {
  @UUIDFieldOptional({
    ...
    example: ['c3611c05-df51-4b47-b601-f2eac02f4ef0', 'c3611c05-df51-4b47-b601-f2eac02f4ef2'],
  })
  ids?: string[];
}
